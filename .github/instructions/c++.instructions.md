...
- Naming conventions: variables and function parameters use lower_snake_case; function names use lower_snake_case; type names (classes/structs/unions/enums) use PascalCase; member fields use lower_snake_case. Avoid to use too-short name even in local scope or loop.
